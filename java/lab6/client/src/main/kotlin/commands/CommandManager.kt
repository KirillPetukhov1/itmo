 ...
 * is thrown by [FileReaderWriter]. [runFromReaderWriter] catches it, prints an error,
 * and resumes execution from the interrupting command line.
 *
 * When EOF is detected (Ctrl+D in interactive mode or end of piped input), [run] exits
...
class CommandManager(
     ...
     * When [readerWriter.readLine] returns null (Ctrl+D or end of piped input),
     * prints a goodbye message and exits the process.
     */
    fun run() {
        while (true) {
        ...
        try {
            ...
            while (nextLine != null) {
                ...
                try {
                    ...
                    fileReaderWriter.writeError("Command \"$commandName\" was not executed: object input was incomplete.")
    ...
    private fun patchFormReaderWriter(rw: AbstractReaderWriter) {
