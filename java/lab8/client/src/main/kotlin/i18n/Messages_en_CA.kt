...
/**
 * English (Canada) resource bundle. Locale tag: en-CA.
 * Uses Canadian English spelling conventions where they differ from the default bundle.
 */
class Messages_en_CA : ListResourceBundle() {
    ...
    override fun getContents(): Array<Array<Any>> = arrayOf(
        ...
        arrayOf(BundleKeys.AUTH_PROMPT_LOGIN, "No account yet? Register"),
        ...
        arrayOf(BundleKeys.COL_PART_NUMBER, "Part No."),
