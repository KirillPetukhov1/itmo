...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "cython_iter4",
        "sources": [
            "C:\\Users\\k4484\\itmo\\itmo-1\\python\\lab10\\cython_iter4.pyx"
        ]
    },
    "module_name": "cython_iter4"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_iter4
#define __PYX_HAVE_API__cython_iter4
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/*--- Type declarations ---*/
struct __pyx_opt_args_12cython_iter4_integrate;
...
/* Module declarations from "cython_iter4" */
static float __pyx_f_12cython_iter4_integrate(PyObject *, float, float, int __pyx_skip_dispatch, struct __pyx_opt_args_12cython_iter4_integrate *__pyx_optional_args); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cython_iter4"
extern int __pyx_module_is_main_cython_iter4;
int __pyx_module_is_main_cython_iter4 = 0;

/* Implementation of "cython_iter4" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12cython_iter4_integrate(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, float __pyx_v_a, float __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_cython_iter4_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_cython_iter4 __pyx_string_tab[7]
#define __pyx_n_u_f __pyx_string_tab[8]
#define __pyx_n_u_func __pyx_string_tab[9]
#define __pyx_n_u_integrate __pyx_string_tab[10]
...
#define __pyx_n_u_n_iter __pyx_string_tab[15]
...
#define __pyx_kp_b_iso88591_Q_Bb_2Q_U_1_q_2QavRq_1 __pyx_string_tab[23]
#define __pyx_int_1000 __pyx_number_tab[0]
...
static PyObject *__pyx_pw_12cython_iter4_1integrate(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static float __pyx_f_12cython_iter4_integrate(PyObject *__pyx_v_f, float __pyx_v_a, float __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_12cython_iter4_integrate *__pyx_optional_args) {
  int __pyx_v_n_iter = ((int)0x3E8);
  float __pyx_v_acc;
  float __pyx_v_step;
  int __pyx_v_i;
  float __pyx_r;
  ...
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_n_iter = __pyx_optional_args->n_iter;
    }
  }
...
*/
  ...
  __pyx_v_step = (__pyx_t_1 / ((float)__pyx_v_n_iter));
 ...
 *     return acc
*/
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_7 = NULL;
    __Pyx_INCREF(__pyx_v_f);
    __pyx_t_8 = __pyx_v_f; 
    __pyx_t_9 = PyFloat_FromDouble((__pyx_v_a + (__pyx_v_i * __pyx_v_step))); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 20, __pyx_L1_error)
    ...
    __pyx_t_8 = PyFloat_FromDouble(__pyx_v_step); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_InPlaceAdd(__pyx_t_5, __pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_1 = __Pyx_PyFloat_AsFloat(__pyx_t_8); if (unlikely((__pyx_t_1 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
...
*/
  ...
  __Pyx_AddTraceback("cython_iter4.integrate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
PyDoc_STRVAR(__pyx_doc_12cython_iter4_integrate, "\n    \320\230\320\275\321\202\320\265\320\263\321\200\320\270\321\200\321\203\320\265\321\202 \320\274\320\265\321\202\320\276\320\264\320\276\320\274 \320\277\321\200\321\217\320\274\320\276\321\203\320\263\320\276\320\273\321\214\320\275\320\270\320\272\320\276\320\262.\n    \n    Args:\n        f (Callable[[float], float]): \320\234\320\260\321\202\320\265\320\274\320\260\321\202\320\270\321\207\320\265\321\201\320\272\320\260\321\217 \321\204\321\203\320\275\320\272\321\206\320\270\321\217 \320\264\320\273\321\217 \320\270\320\275\321\202\320\265\320\263\321\200\320\270\321\200\320\276\320\262\320\260\320\275\320\270\321\217.\n        a (float): \320\235\320\270\320\266\320\275\320\270\320\271 \320\277\321\200\320\265\320\264\320\265\320\273.\n        b (float): \320\222\320\265\321\200\321\205\320\275\320\270\320\271 \320\277\321\200\320\265\320\264\320\265\320\273.\n        n_iter (int): \320\232\320\276\320\273\320\270\321\207\320\265\321\201\321\202\320\262\320\276 \320\270\321\202\320\265\321\200\320\260\321\206\320\270\320\271.\n    \n    Returns:\n        float: \320\267\320\275\320\260\321\207\320\265\320\275\320\270\320\265 \320\262\321\213\321\207\320\270\321\201\320\273\320\265\320\275\320\275\320\276\320\263\320\276 \320\270\320\275\321\202\320\265\320\263\321\200\320\260\320\273\320\260.\n    ");
static PyMethodDef __pyx_mdef_12cython_iter4_1integrate = {"integrate", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12cython_iter4_1integrate, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_12cython_iter4_integrate};
static PyObject *__pyx_pw_12cython_iter4_1integrate(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate", 0) < (0)) __PYX_ERR(0, 2, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate", 0, 3, 4, i); __PYX_ERR(0, 2, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  4:
    ...
    __pyx_v_f = values[0];
    __pyx_v_a = __Pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_a == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_b == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[3]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    } else {
      __pyx_v_n_iter = ((int)0x3E8);
    }
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate", 0, 3, 4, __pyx_nargs); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_12cython_iter4_integrate(__pyx_self, __pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_12cython_iter4_integrate(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, float __pyx_v_a, float __pyx_v_b, int __pyx_v_n_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  float __pyx_t_1;
  struct __pyx_opt_args_12cython_iter4_integrate __pyx_t_2;
  ...
  __pyx_t_1 = __pyx_f_12cython_iter4_integrate(__pyx_v_f, __pyx_v_a, __pyx_v_b, 1, &__pyx_t_2); if (unlikely(__pyx_t_1 == ((float)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L1_error)
  __pyx_t_3 = PyFloat_FromDouble(__pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static int __pyx_pymod_exec_cython_iter4(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_iter4},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_cython_iter4(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_iter4(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_iter4(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_iter4' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cython_iter4" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cython_iter4", 0);
  ...
  if (__pyx_module_is_main_cython_iter4) {
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "cython_iter4")) {
      if (unlikely((PyDict_SetItemString(modules, "cython_iter4", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *       .
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12cython_iter4_1integrate, 0, __pyx_mstate_global->__pyx_n_u_integrate, NULL, __pyx_mstate_global->__pyx_n_u_cython_iter4, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate, __pyx_t_2) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cython_iter4", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cython_iter4");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 *       .
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_int_1000); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 2, __pyx_L1_error)
...
const char* const bytes = "?cython_iter4.pyx__Pyx_PyDict_NextRefaasyncio.coroutinesbcline_in_tracebackcython_iter4f__func__integrate_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefault__test__values\320\000\025\320\025=\270Q\360\036\000\005\013\210!\330\004\014\210B\210b\220\003\2202\220Q\330\004\010\210\005\210U\220!\2201\330\010\017\210q\220\001\220\022\2202\220Q\220a\220v\230R\230q\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 2};
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_cython_iter4_pyx, __pyx_mstate->__pyx_n_u_integrate, __pyx_mstate->__pyx_kp_b_iso88591_Q_Bb_2Q_U_1_q_2QavRq_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
